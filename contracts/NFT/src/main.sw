...
impl NFT for Contract {
    ...
    #[storage(read)]
    fn all_meta_data() -> [TokenMetaData; 2] {
        [storage.meta_data.get(0), storage.meta_data.get(1)]
    // fn all_meta_data(token_id: u64) -> ~Vec<TokenMetaData> {
        // let mut index = 0;
        // let mut meta_data = ~Vec::new();
        // while index < storage.tokens_minted {
        //     meta_data.push(storage.meta_data.get(index));
        //     index += 1;
        // }
        // meta_data
    }
    ...
    #[storage(read, write)]
    fn mint(amount: u64, to: Identity, meta_data: [TokenMetaData; 2]) {
    // fn mint(amount: u64, to: Identity) {
        ...
        while index < total_mint {
            ...
            storage.meta_data.insert(index, meta_data[count]);
